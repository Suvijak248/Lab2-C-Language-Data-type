...
1.1  ทำไม 10 / 3.0 (เมื่อตัวหารเป็น float หรือ double) ถึงได้ผลลัพธ์เป็นทศนิยม แต่เมื่อตัวหารถูกแปลงเป็น int แล้วผลลัพธ์เป็นจำนวนเต็ม?
    ตอบ: เพราะชนิดข้อมูลของตัวหารเป็นตัวกำหนด วิธีการหาร ถ้าเป็นเลขทศนิยม จะได้ผลลัพธ์ทศนิยม แต่ถ้าเป็นจำนวนเต็ม จะปัดเศษลงเหลือจำนวนเต็ม
...
- ในการเขียนโปรแกรม ต้องทำ Type Casting ในสถานการณ์ใดบ้าง
  ตอบ: 1.ต้องเปลี่ยนชนิดข้อมูลให้ตรงกับการคำนวณ 2.ต้องแปลงค่าระหว่างชนิดข้อมูลต่างกัน 3.ต้องป้องกัน Overflow หรือข้อมูลผิดพลาด และทำให้ฟังก์ชันหรือไลบรารีรับค่าชนิดที่ถูกต้อง
