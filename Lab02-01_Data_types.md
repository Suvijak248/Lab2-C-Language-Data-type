...
ตอบ : เพราะ ค่าถูกกำหนดเป็น 100 ซึ่งอยู่ในช่วงของ int แบบ 32-bit โดยไม่มีการคำนวณหรือเกิด Overflow ใดๆ

2.2  สังเกตผลจากการรันโคิดในส่วน 2.2 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ :เพราะ 2147483647 คือค่าสูงสุดของ signed int 32-bit ดังนั้นยังอยู่ในขอบเขตค่าที่ถูกต้อง

2.3  สังเกตผลจากการรันโคิดในส่วน 2.3 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ :เพราะ เกิดการ Integer Overflow ทำให้ค่ากลับไปเป็นค่าต่ำสุด -2147483648 ตามการทำงานของคอมพิวเตอร์ (Two's complement)

2.4  สังเกตผลจากการรันโคิดในส่วน 2.4 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ :เพราะ -2147483648 เป็นค่าต่ำสุดของ signed int 32-bit ซึ่งอยู่ในขอบเขตพอดี

2.5  สังเกตผลจากการรันโคิดในส่วน 2.5 ว่าตรงตามหลักการทางคณิตศาสตร์หรือไม่ เพราะเหตุใด
ตอบ: เพราะ เกิดการ Integer Underflow ทำให้ค่ากลับไปเป็น 2147483647 (ค่าบวกสูงสุด)
