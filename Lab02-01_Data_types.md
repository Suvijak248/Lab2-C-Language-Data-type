...
ตอบ: float แม่นยำน้อยกว่า (ประมาณ 7-8 ตำแหน่ง)   double แม่นยำมากกว่า (ประมาณ 15-16 ตำแหน่ง)

3.2 สถานการณ์ใดที่คุณควรเลือกใช้ double แทน float?
ตอบ: เมื่อต้องการความแม่นยำสูง เช่น งานวิทยาศาสตร์ การคำนวณตัวเลขสำคัญ
...
ตอบ: รหัสตัวเลขแทนตัวอักษร ตัวอักษรแต่ละตัวจะมีค่าเลขประจำตัว

4.2 ถ้าอยากทราบความสัมพันธ์ระหว่างตัวเลขกับอักขระทั้งหมด สามารถหาได้จากเอกสารใด หรือแหล่งอ้างอิงใด
ตอบ: ตาราง ASCII ในหนังสือคอมพิวเตอร์หรือหาในอินเทอร์เน็ตก็ได้
...
ตอบ: ถ้าต้องเก็บจำนวนเต็มบวกที่ใหญ่ที่สุด ให้ใช้ unsigned long หรือ uint32_t (4 ไบต์) หรือ uint64_t ถ้าต้องการใหญ่กว่านี้
...
- เมื่อ myByte ถูกกำหนดให้เป็น 256 ผลลัพธ์ที่ได้คืออะไร และเพราะเหตุใด?
  ตอบ: ผลลัพธ์จะได้ค่า 0 เพราะ byte มีขนาด 8 บิต เก็บค่าได้แค่ 0–255 ค่า 256 จะ ล้น (overflow)
